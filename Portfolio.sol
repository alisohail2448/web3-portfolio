...
contract Portfolio {
    ...
    string public imageLink = "QmYQPTZJmvchbhhpowF2yjpQ1GwVRM8FA1dupiiD4BQaSg";
    string public description = "Skillfull Software Engineer";
    string public resumeLink = "QmVYscxkUBda6Y2RXyTJTUuq5JFBWJHVYhK7cM8LiSCed8";
    ...
    function changeProject(
        ...
        require(
            _projectCount >= 0 && _projectCount < 3,
            "Only 3 projects allowed"
        );
        projects[projectCount] = Project(
            _projectCount,
            _name,
    ...
    function changeResumeLink(string calldata _resumeLink)
        external
        onlyManager
    {
